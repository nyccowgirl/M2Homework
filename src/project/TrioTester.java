...
public class TrioTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Should print a Trio that contains (3, 4, 5):");
        System.out.println("\t"+numberTrio);
        System.out.println("Should print a Trio that contains (hello, goodbye, farewell):");
        ...
        numberTrio2 = new Trio<Integer>(4, 7, 8);
        numberTrio3 = new Trio<Integer>(7, 4, 8);
        testEquals(numberTrio2, numberTrio3, true, "duplicates, same items in different order");

        numberTrio2 = new Trio<Integer>(4, 4, 4);
        numberTrio3 = new Trio<Integer>(4, 4, 4);
        testEquals(numberTrio2, numberTrio3, true, "duplicates, same items in same order");

        numberTrio2 = new Trio<Integer>(1, 2, 3);
        numberTrio3 = new Trio<Integer>(4, 5, 6);
        ...
        System.out.println("\tShould print a Trio that contains(1, 2, 3) (in that order):");
        System.out.println("\t"+numberTrio2);
        System.out.println("\tShould print a Trio that contains(3, 2, 1) (in that order):");
        System.out.println("\t"+numberTrio3);
        if(!(numberTrio2.getItem1()==1 && numberTrio2.getItem2()==2 && numberTrio2.getItem3()==3)) {
            passEquals = false;
        }
        if(!(numberTrio3.getItem1()==3 && numberTrio3.getItem2()==2 && numberTrio3.getItem3()==1)) {
            passEquals = false;
        }
        ...
        System.out.println("\nCheck of the equals method with a non-Trio object passed in:");
        ...
        System.out.println("\nCheck of the equals method used in methods such as contains:");
